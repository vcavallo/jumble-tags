export default {
  translation: {
    ...
    "Author's hashtag": "Hashtag de l'auteur",
    "Author's hashtag — not a decentralized tag yet":
      "Hashtag de l'auteur — pas encore un tag décentralisé",
    'Agree & apply as tag': "D'accord — appliquer comme tag",
    'Disagree & dispute as tag': 'Pas d’accord — contester comme tag',
    'Browse hashtag': 'Parcourir le hashtag',
    'Also hashtagged by the author': "Aussi utilisé comme hashtag par l'auteur",
    'Note posted, but applying a tag failed: {{error}}':
      "Note publiée, mais l'application d'un tag a échoué : {{error}}",
    'Applied {{count}} tag(s) to your note': '{{count}} tag(s) appliqués à votre note',
    'Tags were not applied because the note was posted as a different account':
      "Les tags n'ont pas été appliqués car la note a été publiée avec un autre compte",
    'Decentralized tags for #': 'Tags décentralisés pour #',
    'Typing # opens the decentralized tag picker instead of writing a plain hashtag':
      "Taper # ouvre le sélecteur de tags décentralisés au lieu d'écrire un simple hashtag",
    Tags: 'Tags',
    Hashtags: 'Hashtags',
    Blend: 'Mélange',
    'Show disputed': 'Afficher les contestés',
    'Hide disputed': 'Masquer les contestés',
    'Disputed by the network': 'Contesté par le réseau',
    'No decentralized tag "{{name}}" yet': 'Pas encore de tag décentralisé "{{name}}"',
    'You can bridge it from any note that uses this hashtag':
      "Vous pouvez le créer depuis n'importe quelle note utilisant ce hashtag",
    'Show hashtag posts': 'Voir les publications du hashtag',
    'View tag page': 'Voir la page du tag',
    'Hashtag posts': 'Publications du hashtag',
    'Create & dispute': 'Créer et contester',
    'All hashtags': 'Tous les hashtags',
    'How decentralized tags work': 'Comment fonctionnent les tags décentralisés',
    'A Jumble fork with decentralized tags': 'Un fork de Jumble avec des tags décentralisés',
    'Tags on you': 'Tags sur vous',
    ...
    '{{count}} matching tags are hidden because their creators have no trust score yet.': '{{count}} tags correspondants sont masqués car leurs créateurs n’ont pas encore de score de confiance.'
  }
}
